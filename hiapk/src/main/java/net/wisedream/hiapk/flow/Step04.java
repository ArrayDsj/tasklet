 ...
 *
 */
public class Step04 extends HiapkTask {
	private JSONObject target;
	private String url;

	public Step04() {
		target = context.getAttrib("target");
		url = "http://m.apk.hiapk.com/wap/api.do?qt=1014&pi=1&ps=5"
				+ "&name=" +Uri.encode(target.getString("name"))
				+ "&aid="+target.getString("id");
	}
